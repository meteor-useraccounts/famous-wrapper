...
var timeoutVal = 100;
var timeoutHeight = function(target, op, timeout){
...
Template.atPwdForm.helpers({
    formSize: function(){
        ...
        //console.log('pwd form size: ' + height);
        return [undefined, height];
    },
    inputSize: function(){
...
Template.atPwdForm.rendered = function(){
    ...
    fview.onDestroy = function(){
        console.log('**************************** DESTROYING atPwdForm');
    };
};
...
Template.atInput.rendered = function(){
    ...
    var self = this;
    fview.onDestroy = function(){
        console.log('**************************** DESTROYING atInput');
        //var height = content.firstNode.parentNode.parentNode.clientHeight;
        //console.log('DESTROYING input height: ' + height);
        //atFormSizes.set('pwdForm', atFormSizes.get('pwdForm') - height);
        //atFormSizes.set('pwdInput', height);
    };
};
Template.atPwdLink.rendered = function(){
    ...
    var fview = FView.fromTemplate(this);
    fview.onDestroy = function(){
        console.log('**************************** DESTROYING atPwdLink');
    };
};
...
Template.atSigninLink.events({
   'click #at-signIn': AccountsTemplates.atSigninLinkEvents["click #at-signIn"]
});

Template.atSignupLink.events({
   'click #at-signUp': AccountsTemplates.atSignupLinkEvents["click #at-signUp"]
});

Template.atPwdLink.events({
   'click #at-forgotPwd': AccountsTemplates.atPwdLinkEvents["click #at-forgotPwd"]
});
