...
Package.on_use(function(api, where) {
    ...
    api.use("useraccounts:unstyled@0.11.0", ["client", "server"], { weak: true });
    api.use("useraccounts:bootstrap@0.11.0", ["client", "server"], { weak: true });
    api.use("useraccounts:foundation@0.11.0", ["client", "server"], { weak: true });
    api.use("useraccounts:semantic-ui@0.11.0", ["client", "server"], { weak: true });
