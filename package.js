...
Package.on_use(function(api, where) {
  ...
  api.use('useraccounts:bootstrap@1.12.4', ['client', 'server'], {
    weak: true
  });
  api.use('useraccounts:foundation@1.12.4', ['client', 'server'], {
    weak: true
  });
  ...
  api.use('useraccounts:semantic-ui@1.12.4', ['client', 'server'], {
    weak: true
  });
  api.use('useraccounts:unstyled@1.12.4', ['client', 'server'], {
    weak: true
  });
