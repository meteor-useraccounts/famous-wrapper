...
Package.on_use(function(api, where) {
    ...
    api.use("useraccounts:bootstrap@1.4.1", ["client", "server"], { weak: true });
    api.use("useraccounts:foundation@1.4.1", ["client", "server"], { weak: true });
    api.use("useraccounts:ionic@1.3.2", ["client", "server"], { weak: true });
    api.use("useraccounts:ratchet@1.3.2", ["client", "server"], { weak: true });
    api.use("useraccounts:semantic-ui@1.4.1", ["client", "server"], { weak: true });
    api.use("useraccounts:unstyled@1.4.1", ["client", "server"], { weak: true });
