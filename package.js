...
Package.on_use(function(api, where) {
    ...
    api.use("splendido:accounts-templates-unstyled@0.9.16", ["client", "server"], { weak: true });
    api.use("splendido:accounts-templates-bootstrap@0.9.16", ["client", "server"], { weak: true });
    api.use("splendido:accounts-templates-foundation@0.9.16", ["client", "server"], { weak: true });
    api.use("splendido:accounts-templates-semantic-ui@0.9.16", ["client", "server"], { weak: true });
